...
def main(shots=5, tasks_per_batch=16, adapt_lr=0.01, meta_lr=0.001, adapt_steps=5,):
    ...
    tasksets = TaskDataset(all_IDs, data_dir=data_dir, num_shots=shots, len_signal=625)
