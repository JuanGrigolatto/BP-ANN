...
setup(
    ...
    description="Blood Pressure Estimation using Convolutional Neural Networks and Metalearning",
    ...
    classifiers=[
        ...
        "Topic :: Scientific/Engineering :: Bio-engeneering",
        "Topic :: Scientific/Engineering :: Medical Instruments and Supplies",
    ],
    python_requires=">=3.9",
