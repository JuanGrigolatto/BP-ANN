...
def main():
    ...
    torch.save({'data': test_signals, 'labels': test_labels,'patient_ids': test_IDs,'index':test_index} ,'data/processed/data_UCI/test_set.pt')
    ...
    for epoch in tqdm(range(max_epochs)):
        ...
        if valid_l < best_valid_loss:
            ...
            torch.save({
                ...
                'loss': valid_l
            }, 'models/best_models/best_model_conv_v1_aug.pt')
